...
class HelpWindow:
    ...
    def refresh(self):
        ...
        base = (
            ...
            "• Inspect Selected Channel(s): Plots the selected channels from \"Channels in Trial,\" with sentinel cleaning and interpolation applied.\n"
            "• Mark Good: Marks the selected trial as good quality.\n"
            "• Mark Bad: Marks the selected trial as unusable.\n"
            "• Mark Review: Flags the selected trial for further review.\n"
            "• Clear Mark: Removes the quality mark from the selected trial.\n"
            "• Add Notes: Opens a dialog to attach free-text notes to the selected trial.\n\n"
